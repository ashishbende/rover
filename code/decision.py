...
def decision_step(Rover):
    ...
    if Rover.mode == 'doughnut':
        print('Executing escape doughnut lock')
    ...
    if Rover.mode == 'stuck':
        print('Stuck! Executing evasion plan')
        ...
        if Rover.mode == 'forward':
            ...
            if Rover.sample_seen:
                if Rover.picking_up != 0:
                    print('Successfully picked up the sample')
                ...
                if time.time() - Rover.sample_timer > Rover.sample_max_search:
                    print('Time elapsed! Unable to find sample')
                    Rover.sample_seen = False
                    Rover.sample_timer = time.time()
                    return Rover
                ...
                if -15 < avg_rock_angle < 15:
                    ...
                    print('Approaching a sample head on')
                    ...
                    print('Steering To Sample: ', avg_rock_angle)
                    ...
                    print('Opps! Sample is out of sight')
                    Rover.sample_seen = False
